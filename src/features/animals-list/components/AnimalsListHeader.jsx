        ...
        <div className="relative h-full flex flex-col justify-center max-md:px-6 md:px-8 max-md:py-6 md:py-0">
          ...
          >
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-green-300/20 rounded-xl backdrop-blur-md">
                  <Beef className="max-md:w-6 max-md:h-6 md:w-8 md:h-8 text-green-300" />
                </div>
            ...
            <div className="flex max-sm:flex-col sm:flex-row gap-3 max-sm:w-full sm:w-auto">
              {onExport && (
                <div className="max-sm:w-full max-sm:block sm:hidden">
                  <Button
                    onClick={onExport}
                    variant="outline"
                    icon={Download}
                    className="w-full bg-white/10 border-white/20 text-white font-semibold max-sm:py-2.5"
                  >
                    Exportar Reporte
                  </Button>
                </div>
              ...
              >
                <Button
                  ...
                  variant="primary"
                  icon={Plus}
                  className="max-sm:w-full sm:w-auto bg-white text-green-800 hover:bg-green-50 shadow-lg font-bold max-sm:py-2.5 sm:py-2 px-6 rounded-xl"
                >
                  Agregar Animal
                </Button>
              </motion.div>
