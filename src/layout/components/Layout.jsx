...
export function Layout({ children }) {
  ...
  const menuItems = [
    ...
    { title: "Animales", icon: Beef, active: true },
    { title: "Salud", icon: Calendar, active: false },
    { title: "Alimentación", icon: ClipboardList, active: false },
  ];
  ...
  return (
    <div className="min-h-screen bg-white flex font-sans">
      ...
      >
        <div className="h-16 flex items-center gap-3 px-4 border-b border-gray-50 bg-white shrink-0">
      ...
      >
        ...
        {/* Nested Content Area (Matches Shell Exactly) */}
